...
model = dict(type='Detector',
             backbone=dict(type='CBTransformer',
                           embed_dim=128,
                           cb_del_stages=1,
                           depths=[2, 2, 18, 2],
                           num_heads=[4, 8, 16, 32],
             ...
             roi_head=dict(type='HybridTaskCascadeRoIHead',
                           ...
                           bbox_head=[dict(type='Shared4Conv1FCBoxHead',
                                           num_classes=2,
                                           bbox_coder=dict(type='DeltaXYWHBBoxCoder',
                                                           target_means=[0., 0., 0., 0.],
                                           ...
                                           loss_bbox=dict(type='SmoothL1Loss',
                                                          beta=1.0,
                                                          loss_weight=1.0)),
                                      dict(type='Shared4Conv1FCBoxHead',
                                           num_classes=2,
                                           bbox_coder=dict(type='DeltaXYWHBBoxCoder',
                                                           target_means=[0., 0., 0., 0.],
                                      ...
                                      dict(type='Shared4Conv1FCBoxHead',
                                           ...
                                           loss_bbox=dict(type='SmoothL1Loss',
                                                          beta=1.0,
                                                          loss_weight=1.0))],
                           mask_roi_extractor=dict(type='RoIExtractor',
                                                   roi_layer=dict(type='RoIAlign',
                                                                  output_size=14,
                                                                  sampling_ratio=0),
                                                   out_channels=256,
...
optimizer_config = dict(type="DistributedOptimizerHook",
                        update_interval=1,
                        grad_clip=None,
                        coalesce=True,
                        bucket_size_mb=-1,
